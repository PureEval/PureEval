...
import { add,minus,mul,div,mod,rema,power,either,both,gt,gte,lt,lte,equal,upper,under,sort,sum,negate,average,median,max,min } from './src/math.js'
...
export {
    ...
    add,minus,mul,div,mod,rema,power,either,both,gt,gte,lt,lte,equal,upper,under,sort,sum,negate,average,median,max,min,
    range,
    compose,pipe,call,
    _,bind
}