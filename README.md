...
[![](https://img.shields.io/badge/License-GPL-green)](https://github.com/Lampese/PureEval/blob/main/LICENSE) ![](https://img.shields.io/badge/version-v2.1-red) [![](https://img.shields.io/badge/npm-pureeval-blue.svg)](https://www.npmjs.com/pureeval)
...
- 支持对任意参数函数的柯里化和复变。
- 大量可以参与函数式编程的实用函数。
- 支持懒惰求值的列表（coming soon）。
- 拥有可用的 Maybe、Either、Task 等抽象结构。
