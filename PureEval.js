...
import { either, both, not, gt, gte, lt, lte, equal, arrEqual, id, always, when, unless, ifElse } from './src/logic.js';
...
export {
	...
	compose, pipe, call,
	_, bind,
	either, both, not, gt, gte, lt, lte, equal, arrEqual, id, always, when, unless, ifElse,
	match,
	Data,
