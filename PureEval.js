...
import { either, both, not, gt, gte, lt, lte, equal, arrEqual, id, always, when, unless, ifElse, when_v, unless_v, ifElse_v } from './src/logic.js';
...
export {
	...
	compose, pipe, call,
	_, bind,
	either, both, not, gt, gte, lt, lte, equal, arrEqual, id, always, when, unless, ifElse, when_v, unless_v, ifElse_v,
	match,
	Data,
